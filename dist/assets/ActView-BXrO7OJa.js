import{d as p,g as f,r as s,a8 as w,j as t,I as a,i as d,a2 as g}from"./index-DeGWQ4ER.js";import{C as c}from"./CrmLayout-BloErrV6.js";import{d as j}from"./downloadContractPdf-D85GtCRN.js";import{d as y,a as k}from"./docBrandHeader-JXNeFJWC.js";function z(){const{actId:i}=p(),m=f(),[e,u]=s.useState(null),[h,o]=s.useState(!0),[r,l]=s.useState(!1);s.useEffect(()=>{i&&(o(!0),w.get(Number(i)).then(u).catch(()=>m("/cabinet/documents")).finally(()=>o(!1)))},[i]);const x=()=>{if(!e)return;const n=window.open("","_blank");n&&(n.document.write(`
      <html>
        <head>
