import{c as f,f as p,r as s,a5 as w,j as t,I as a,h as d,$ as g}from"./index-D1HI9Lxo.js";import{C as c}from"./CrmLayout-B9DvLgO6.js";import{d as j}from"./downloadContractPdf-DYnairpw.js";import{d as y,a as k}from"./docBrandHeader-BQ_EeXF9.js";function z(){const{actId:i}=f(),m=p(),[e,u]=s.useState(null),[h,o]=s.useState(!0),[r,l]=s.useState(!1);s.useEffect(()=>{i&&(o(!0),w.get(Number(i)).then(u).catch(()=>m("/cabinet/documents")).finally(()=>o(!1)))},[i]);const x=()=>{if(!e)return;const n=window.open("","_blank");n&&(n.document.write(`
      <html>
        <head>
