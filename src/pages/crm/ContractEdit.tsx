    ...
    <CrmLayout title="Конструктор договора" subtitle={`Объект: ${object.object_code} · ${object.client_name}`}>
      ...
      <div className="max-w-3xl mx-auto bg-[#1c1c1c] border border-white/10 rounded-2xl px-6 sm:px-10 py-8 text-[15px] leading-relaxed text-white/80 contract-live">
        ...
        <ToggleGroup
          ...
          options={[
            { value: "contractor", label: "Материалы Подрядчика" },
            { value: "customer", label: "Материалы Заказчика" },
            { value: "mixed", label: "Смешанная закупка" },
          ]}
        />
        <p>
          3.6.{" "}
          {{
            contractor:
              "Закупку строительных и отделочных материалов осуществляет Подрядчик. Стоимость материалов включена в цену Работ либо возмещается Заказчиком по фактическим расходам на основании подтверждающих документов.",
            customer:
              "Закупку строительных и отделочных материалов осуществляет Заказчик своими силами и за свой счёт. Подрядчик не несёт ответственности за качество и сроки поставки предоставленных Заказчиком материалов.",
            mixed:
              "Закупка материалов осуществляется Сторонами совместно: черновые и расходные материалы приобретает Подрядчик, чистовые и отделочные материалы — Заказчик. Конкретный перечень определяется Сметой (Приложение №1).",
          }[options.materials]}
        </p>
