        ...
        <div className="flex flex-col gap-4 mt-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={saving}
              className="flex-1 flex items-center justify-center gap-2 bg-[#D4AF37] hover:bg-[#B8860B] transition-colors text-[#161616] text-sm px-4 py-3 rounded-lg disabled:opacity-60"
            >
