import{l as p,a as f,r as s,Y as w,j as t,I as a,L as d,S as g}from"./index-D1nFiJEp.js";import{C as c}from"./CrmLayout-Dt4S5URw.js";import{d as j}from"./downloadContractPdf-smuhHlCh.js";import{d as y,a as k}from"./docBrandHeader-BQ_EeXF9.js";function z(){const{actId:i}=p(),m=f(),[e,u]=s.useState(null),[h,o]=s.useState(!0),[r,l]=s.useState(!1);s.useEffect(()=>{i&&(o(!0),w.get(Number(i)).then(u).catch(()=>m("/cabinet/documents")).finally(()=>o(!1)))},[i]);const x=()=>{if(!e)return;const n=window.open("","_blank");n&&(n.document.write(`
      <html>
        <head>
