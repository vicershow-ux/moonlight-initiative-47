import{n as p,b as j,r as a,q as w,j as e,I as n,L as r,V as y}from"./index-C8c8jLgF.js";import{C as m}from"./CrmLayout-BcqxLqXg.js";import{d as N}from"./downloadContractPdf-CHEFl8gs.js";import{d as v,a as _}from"./docBrandHeader-BQ_EeXF9.js";function P(){const{id:x,contractId:i}=p(),u=j(),o=Number(x),[t,h]=a.useState(null),[f,c]=a.useState(!0),[l,d]=a.useState(!1);a.useEffect(()=>{i&&(c(!0),w.get(Number(i)).then(h).catch(()=>u("/cabinet/documents")).finally(()=>c(!1)))},[i]);const b=()=>{if(!t)return;const s=window.open("","_blank");s&&(s.document.write(`
      <html>
        <head>
