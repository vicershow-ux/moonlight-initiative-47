import{n as p,b as f,r as s,a0 as w,j as t,I as a,L as d,W as g}from"./index-B7tvk1jj.js";import{C as c}from"./CrmLayout-Dg2v38LH.js";import{d as j}from"./downloadContractPdf-CfFcdgs2.js";import{d as y,a as k}from"./docBrandHeader-BQ_EeXF9.js";function z(){const{actId:i}=p(),m=f(),[e,u]=s.useState(null),[h,o]=s.useState(!0),[r,l]=s.useState(!1);s.useEffect(()=>{i&&(o(!0),w.get(Number(i)).then(u).catch(()=>m("/cabinet/documents")).finally(()=>o(!1)))},[i]);const b=()=>{if(!e)return;const n=window.open("","_blank");n&&(n.document.write(`
      <html>
        <head>
