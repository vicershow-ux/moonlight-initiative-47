import{n as p,b as j,r as a,q as w,j as e,I as n,L as r,W as y}from"./index-B7tvk1jj.js";import{C as m}from"./CrmLayout-Dg2v38LH.js";import{d as N}from"./downloadContractPdf-CfFcdgs2.js";import{d as v,a as _}from"./docBrandHeader-BQ_EeXF9.js";function P(){const{id:x,contractId:i}=p(),u=j(),o=Number(x),[t,h]=a.useState(null),[f,c]=a.useState(!0),[l,d]=a.useState(!1);a.useEffect(()=>{i&&(c(!0),w.get(Number(i)).then(h).catch(()=>u("/cabinet/documents")).finally(()=>c(!1)))},[i]);const b=()=>{if(!t)return;const s=window.open("","_blank");s&&(s.document.write(`
      <html>
        <head>
