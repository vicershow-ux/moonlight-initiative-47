import{n as p,b as f,r as s,$ as w,j as t,I as a,L as d,V as g}from"./index-C8c8jLgF.js";import{C as c}from"./CrmLayout-BcqxLqXg.js";import{d as j}from"./downloadContractPdf-CHEFl8gs.js";import{d as y,a as k}from"./docBrandHeader-BQ_EeXF9.js";function z(){const{actId:i}=p(),m=f(),[e,u]=s.useState(null),[h,o]=s.useState(!0),[r,l]=s.useState(!1);s.useEffect(()=>{i&&(o(!0),w.get(Number(i)).then(u).catch(()=>m("/cabinet/documents")).finally(()=>o(!1)))},[i]);const b=()=>{if(!e)return;const n=window.open("","_blank");n&&(n.document.write(`
      <html>
        <head>
