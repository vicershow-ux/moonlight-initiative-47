import{c as b,f as j,r as a,x as w,j as e,I as n,h as r,$ as y}from"./index-yWc5KzS2.js";import{C as m}from"./CrmLayout-BRYKBXwp.js";import{d as N}from"./downloadContractPdf-DqDOowBJ.js";import{d as v,a as _}from"./docBrandHeader-BQ_EeXF9.js";function P(){const{id:x,contractId:i}=b(),u=j(),o=Number(x),[t,h]=a.useState(null),[f,c]=a.useState(!0),[l,d]=a.useState(!1);a.useEffect(()=>{i&&(c(!0),w.get(Number(i)).then(h).catch(()=>u("/cabinet/documents")).finally(()=>c(!1)))},[i]);const g=()=>{if(!t)return;const s=window.open("","_blank");s&&(s.document.write(`
      <html>
        <head>
