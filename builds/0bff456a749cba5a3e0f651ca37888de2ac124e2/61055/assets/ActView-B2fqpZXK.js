import{l as p,a as f,r as s,Y as w,j as t,I as a,L as c,S as g}from"./index-DnEYpLOk.js";import{C as d}from"./CrmLayout-Dxq6oEw_.js";import{d as j}from"./downloadContractPdf-DXUgmEyP.js";function N(){const{actId:i}=p(),m=f(),[e,u]=s.useState(null),[h,o]=s.useState(!0),[r,l]=s.useState(!1);s.useEffect(()=>{i&&(o(!0),w.get(Number(i)).then(u).catch(()=>m("/cabinet/documents")).finally(()=>o(!1)))},[i]);const x=()=>{if(!e)return;const n=window.open("","_blank");n&&(n.document.write(`
      <html>
        <head>
