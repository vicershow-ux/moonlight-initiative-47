const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/html2pdf-DyCOX9YJ.js","assets/index-BzVJ_BGd.js","assets/index-DWeznoHc.css"])))=>i.map(i=>d[i]);
import{a9 as y}from"./index-BzVJ_BGd.js";const g=(t,a=0)=>{const r=typeof t=="string"?parseFloat(t):Number(t);return Number.isFinite(r)?r:a},u=t=>new Intl.NumberFormat("ru-RU",{maximumFractionDigits:0}).format(g(t))+" ₽",$=t=>new Date(t).toLocaleString("ru-RU",{day:"numeric",month:"numeric",year:"numeric",hour:"2-digit",minute:"2-digit"});function n(t){const a=document.createElement("div");return a.textContent=t??"",a.innerHTML}function k(t,a){const r=new Map;return t.forEach(d=>{const e=a.find(i=>i.id===d.material_id),l=d.shop_name||(e==null?void 0:e.shop_name)||"Магазин не указан";r.has(l)||r.set(l,{name:l,address:"",phone:"",items:[],sum:0});const o=r.get(l);!o.address&&(e!=null&&e.shop_address)&&(o.address=e.shop_address),!o.phone&&(e!=null&&e.shop_phone)&&(o.phone=e.shop_phone),o.items.push(d),o.sum+=g(d.qty)*g(d.price)}),Array.from(r.values()).sort((d,e)=>e.sum-d.sum)}function v(t,a,r,d){const e=k(a,r),l=e.reduce((c,b)=>c+b.sum,0),o=Array.from(new Set(a.map(c=>c.room_name).filter(Boolean))),i=o.length?o.join(", "):"Без помещения",s=e.map(c=>{const b=c.items.map((m,w)=>`
            <tr>
              <td class="num">${w+1}</td>
              <td>${n(m.name)}</td>
              <td>${n(m.room_name||"—")}</td>
