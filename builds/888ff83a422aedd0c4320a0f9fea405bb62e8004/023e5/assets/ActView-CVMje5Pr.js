import{d as p,g as f,r as s,a6 as w,j as t,I as a,i as d,a0 as g}from"./index-BzVJ_BGd.js";import{C as c}from"./CrmLayout-P3EWRCGk.js";import{d as j}from"./downloadContractPdf-G2QWwva9.js";import{d as y,a as k}from"./docBrandHeader-JXNeFJWC.js";function z(){const{actId:i}=p(),m=f(),[e,u]=s.useState(null),[h,o]=s.useState(!0),[r,l]=s.useState(!1);s.useEffect(()=>{i&&(o(!0),w.get(Number(i)).then(u).catch(()=>m("/cabinet/documents")).finally(()=>o(!1)))},[i]);const x=()=>{if(!e)return;const n=window.open("","_blank");n&&(n.document.write(`
      <html>
        <head>
