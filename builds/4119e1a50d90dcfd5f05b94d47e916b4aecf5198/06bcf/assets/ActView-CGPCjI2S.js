import{l as p,a as f,r as s,X as w,j as t,I as a,L as c,i as g}from"./index-kQh1NvXh.js";import{C as d}from"./CrmLayout-B-__865s.js";import{d as j}from"./downloadContractPdf-JWA89ZCe.js";function N(){const{actId:i}=p(),m=f(),[e,u]=s.useState(null),[h,o]=s.useState(!0),[r,l]=s.useState(!1);s.useEffect(()=>{i&&(o(!0),w.get(Number(i)).then(u).catch(()=>m("/cabinet/documents")).finally(()=>o(!1)))},[i]);const x=()=>{if(!e)return;const n=window.open("","_blank");n&&(n.document.write(`
      <html>
        <head>
