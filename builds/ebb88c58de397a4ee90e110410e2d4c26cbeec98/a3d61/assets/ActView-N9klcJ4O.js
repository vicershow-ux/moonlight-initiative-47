import{k as p,a as f,r as s,W as w,j as t,I as a,L as c,O as g}from"./index-DR0OcWc8.js";import{C as d}from"./CrmLayout-CSUDW4sc.js";import{d as j}from"./downloadContractPdf-BaEsJqjl.js";function N(){const{actId:i}=p(),m=f(),[e,u]=s.useState(null),[h,o]=s.useState(!0),[r,l]=s.useState(!1);s.useEffect(()=>{i&&(o(!0),w.get(Number(i)).then(u).catch(()=>m("/cabinet/documents")).finally(()=>o(!1)))},[i]);const x=()=>{if(!e)return;const n=window.open("","_blank");n&&(n.document.write(`
      <html>
        <head>
