import{k as f,a as b,r as i,m as g,j as e,I as n,L as c,O as p}from"./index-CF3utCXJ.js";import{C as l}from"./CrmLayout-BWbDKcaa.js";function y(){const{id:o,contractId:a}=f(),d=b(),m=Number(o),[t,x]=i.useState(null),[u,r]=i.useState(!0);i.useEffect(()=>{a&&(r(!0),g.get(Number(a)).then(x).catch(()=>d("/cabinet/documents")).finally(()=>r(!1)))},[a]);const h=()=>{if(!t)return;const s=window.open("","_blank");s&&(s.document.write(`
      <html>
        <head>
