import{d as b,g as j,r as a,y as w,j as e,I as n,i as r,a0 as y}from"./index-DDdv5V9S.js";import{C as m}from"./CrmLayout-DkrFa8vi.js";import{d as N}from"./downloadContractPdf-CuaefvwP.js";import{d as v,a as _}from"./docBrandHeader-BQ_EeXF9.js";function P(){const{id:x,contractId:i}=b(),u=j(),o=Number(x),[t,h]=a.useState(null),[f,c]=a.useState(!0),[l,d]=a.useState(!1);a.useEffect(()=>{i&&(c(!0),w.get(Number(i)).then(h).catch(()=>u("/cabinet/documents")).finally(()=>c(!1)))},[i]);const g=()=>{if(!t)return;const s=window.open("","_blank");s&&(s.document.write(`
      <html>
        <head>
